...
class WxpayService
{
    ...
    protected $apiKey;
    protected $appKey;
    public function __construct($mchid, $appid, $apiKey, $appKey = null)
    {
     ...
     * @return array
     */
    public function h5pay($payAmount,$outTradeNo,$orderName,$notifyUrl,$wapName,$wapUrl,$returnUrl)
    {
        $config = array(
            'mch_id' => $this->mchid,
            'appid' => $this->appid,
        ...
        $unified = array(
            ...
            'total_fee' => floatval($payAmount) * 100,       //单位 转为分
            'trade_type' => 'MWEB',
        ...
        if($unifiedOrder->mweb_url){
            return $unifiedOrder->mweb_url.'&redirect_url='.urlencode($returnUrl);
        }
        exit('error');
    }
	/**
     ...
     * @return string
     */
    public function jsapipay($openid, $totalFee, $outTradeNo, $orderName, $notifyUrl, $timestamp)
    {
        $config = array(
            'mch_id' => $this->mchid,
            'appid' => $this->appid,
