...
return [
    ...
    'route_config_file' =>  ['admin','madmin','mobile','jingdian','integral'],   // 设置路由配置文件列表
    ...
    'trace' => [
        'type' => 'console',       // 在当前Html页面显示Trace信息,显示方式console、html
    ],
    ...
    'exception_tmpl'  => APP_PATH . '/exception/view/404.html',
    'default_module'  => 'jingdian',
    ...
    'cookie'        => [      
        'prefix'    => '',// cookie 名称前缀      
        'expire'    => 60*60*24*30,// cookie 保存时间      
        'path'      => '/',// cookie 保存路径      
        'domain'    => '',// cookie 有效域名      
