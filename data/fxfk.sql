...
UPDATE `think_auth_rule` SET `status` = 0 WHERE `id` IN (13,24,48,70,83,92,103,106,110);
UPDATE `think_auth_rule` SET `status` = 0 WHERE `pid` IN (13,24,48,70,83,92,103,106,110);
UPDATE `think_auth_rule` c INNER JOIN `think_auth_rule` p ON c.`pid` = p.`id` SET c.`status` = 0 WHERE p.`pid` IN (13,24,48,70,83,92,103,106,110);
