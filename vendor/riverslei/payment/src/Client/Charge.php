...
class Charge
{
    private static $supportChannel = [
        Configv::ALI_CHANNEL_APP,// 支付宝 APP 支付
        Configv::ALI_CHANNEL_WAP, // 支付宝手机网页支付
        Configv::ALI_CHANNEL_WEB, // 支付宝电脑网站支付
        Configv::ALI_CHANNEL_QR, // 支付宝当面付-扫码支付
        Configv::ALI_CHANNEL_BAR,// 支付宝当面付-条码支付

        Configv::WX_CHANNEL_APP,// 微信 APP 支付
        Configv::WX_CHANNEL_PUB,// 微信公众号支付
        Configv::WX_CHANNEL_QR,// 微信公众号扫码支付
        Configv::WX_CHANNEL_BAR,// 微信刷卡支付
        Configv::WX_CHANNEL_WAP,// 微信 WAP 支付（此渠道仅针对特定客户开放）
        Configv::WX_CHANNEL_LITE,// 微信小程序支付

        Configv::CMB_CHANNEL_APP,// 招行一网通
