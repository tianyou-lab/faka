!function (e, t) {
    ...
    function d(e, t) {
        ...
        var i = o('<div class="w-e-droplist"></div>'), A = t.$title;
        A && (A.addClass("w-e-dp-title"), i.append(A));
        var r = t.list || [], c = t.type || "list", a = t.onClick || j,
            s = o('<ul class="' + ("list" === c ? "w-e-list" : "w-e-block") + '"></ul>');
        i.append(s), r.forEach(function (e) {
            var t = e.$elem, i = e.value, A = o('<li class="w-e-item"></li>');
            t && (A.append(t), s.append(A), t.on("click", function (e) {
                a(i), n.hideTimeoutId = setTimeout(function () {
                    n.hide()
                }, 0)
            }))
        ...
        }), this.$container = i, this._rendered = !1, this._show = !1
    }
    ...
    function C(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-pencil2"><i/></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 120,
            $title: o("<p>文字颜色</p>"),
            type: "inline-block",
            list: [{
                ...
                value: "#f9963b"
            }, {$elem: o('<i style="color:#ffffff;" class="w-e-icon-pencil2"></i>'), value: "#ffffff"}],
            onClick: function (e) {
                t._command(e)
            }
        })
    ...
    function B(e) {
        var t = this;
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-paint-brush"><i/></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 120,
            $title: o("<p>背景色</p>"),
            type: "inline-block",
            list: [{
                ...
                value: "#f9963b"
            }, {$elem: o('<i style="color:#ffffff;" class="w-e-icon-paint-brush"></i>'), value: "#ffffff"}],
            onClick: function (e) {
                t._command(e)
            }
        })
    ...
    function k(e) {
        var t = e.clipboardData || e.originalEvent.clipboardData, n = void 0;
        return n = null == t ? window.clipboardData && window.clipboardData.getData("text") : t.getData("text/plain"), a(n)
    }

    function _(e) {
        var t = e.clipboardData || e.originalEvent.clipboardData, n = void 0, i = void 0;
    ...
    function R(e) {
        var t = [];
        if (k(e))return t;
        var n = e.clipboardData || e.originalEvent.clipboardData || {}, i = n.items;
    ...
    h.prototype = {
        constructor: h, show: function () {
            var e = this, t = this.menu;
            if (!($.indexOf(t) >= 0)) {
                var n = t.editor, i = n.$textContainerElem, A = this.opt,
                    r = o('<div class="w-e-panel-container"></div>'), c = A.width || 300;
                r.css("width", c + "px").css("margin-left", (0 - c) / 2 + "px");
                var a = o('<ul class="w-e-panel-tab-title"></ul>'), s = o('<div class="w-e-panel-tab-content"></div>');
                r.append(a).append(s);
                var l = A.height;
                l && s.css("height", l + "px").css("overflow-y", "scroll");
                var d = A.tabs || [], u = [], h = [];
                d.forEach(function (e, t) {
                    if (e) {
                        var n = e.title || "", i = e.tpl || "", A = o('<li class="w-e-item">' + n + "</li>");
                        a.append(A);
                        var r = o(i);
                        s.append(r), A._index = t, u.push(A), h.push(r), 0 === t ? (A._active = !0, A.addClass("w-e-active")) : r.hide(), A.on("click", function (e) {
                            A._active || (u.forEach(function (e) {
                                e._active = !1, e.removeClass("w-e-active")
                            }), h.forEach(function (e) {
                                e.hide()
                            }), A._active = !0, A.addClass("w-e-active"), r.show())
                        })
                    }
                    ...
                    e.hide()
                }), i.append(r), d.forEach(function (t, n) {
                    if (t) {
                        (t.events || []).forEach(function (t) {
                            var i = t.selector, o = t.type, A = t.fn || z;
                            h[n].find(i).on(o, function (t) {
                                t.stopPropagation(), A(t) && e.hide()
                            })
                        })
                    }
                });
                var p = r.find("input[type=text],textarea");
                p.length && p.get(0).focus(), this.$container = r, this._hideOtherPanels(), $.push(t)
            }
        }, hide: function () {
        ...
        constructor: p, onClick: function (e) {
            ...
            var n = this, i = c("input-link"), A = c("input-text"), r = c("btn-ok"), a = c("btn-del"),
                s = this._active ? "inline-block" : "none", l = new h(this, {
                    width: 300,
                    tabs: [{
                        title: "链接",
        ...
        constructor: y, onClick: function (e) {
        ...
        constructor: x, onClick: function (e) {
            ...
            var t = this;
            e = e || "";
            var n = e ? "edit" : "new", i = c("texxt"), A = c("btn"), r = new h(this, {
                width: 500,
                tabs: [{
                    title: "插入代码",
        ...
        constructor: Q, onClick: function () {
            ...
            var e = this, t = c("btn"), n = c("row"), i = c("col"), A = new h(this, {
                width: 250,
                tabs: [{
                    title: "插入表格",
            ...
            o += "</table><p><br></p>", this.editor.cmd.do("insertHTML", o)
        ...
        constructor: D, onClick: function () {
            ...
            var e = this, t = c("text-val"), n = c("btn"), i = new h(this, {
                width: 350,
                tabs: [{
                    title: "插入视频",
        ...
        constructor: M, onClick: function () {
            ...
            (n.uploadImgShowBase64 || n.uploadImgServer) && window.FileReader && l.push(s[0]), n.showLinkImg && l.push(s[1]);
    ...
    var G = {};
    G.bold = l, G.head = u, G.link = p, G.italic = f, G.redo = g, G.strikeThrough = m, G.underline = w, G.undo = v, G.list = b, G.justify = E, G.foreColor = C, G.backColor = B, G.quote = y, G.code = x, G.emoticon = I, G.table = Q, G.video = D, G.image = M, U.prototype = {
        constructor: U,
        init: function () {
        ...
        constructor: S, init: function () {
            ...
            this.editor.$textElem.append(o(e))
        }, _bindEvent: function () {
            ...
            function e(e) {
                ...
                if (t.parent().equal(i) && (t.getNodeName(), !t.text())) {
                    var A = o("<p><br></p>");
            ...
            function t(e) {
                var t = n.selection.getSelectionContainerElem();
                if (t) {
                    var i = t.parent(), o = t.getNodeName(), A = i.getNodeName()
                    ;
            ...
            var n = this.editor, i = n.$textElem;
            ...
            t.on("paste", function (n) {
                n.preventDefault();
                var i = void 0, o = void 0, A = e.selection.getSelectionContainerElem();
                if (A) {
                    var r = A.getNodeName();
        ...
        constructor: F, getRange: function () {
            ...
            t && this.isSelectionEmpty() && (L.isWebkit() ? (e.cmd.do("insertHTML", "&#8203;"), t.setEnd(t.endContainer, t.endOffset + 1), this.saveRange(t)) : (n = o("<strong>&#8203;</strong>"), e.cmd.do("insertElem", n), this.createRangeByElem(n, !0)))
    ...
    T.prototype = {
        constructor: T, _alert: function (e, t) {
            if (this.editor.config.debug)throw new Error("wangEditor: " + (t || e));
            alert(e)
        }, insertLinkImg: function (e) {
            var t = this;
            if (e) {
                var n = this.editor, i = document.createElement("img");
                i.onload = function () {
            ...
            var t = this;
            if (e && e.length) {
                var n = this.editor, i = n.config, o = i.uploadImgMaxSize, c = o / 1e3 / 1e3, a = i.uploadImgServer,
                    l = i.uploadImgShowBase64, d = i.uploadImgParams || {}, u = i.uploadImgHeaders || {},
                    h = i.uploadImgHooks || {}, p = i.uploadImgTimeout || 3e3, f = i.withCredentials;
                null == f && (f = !1);
                var g = [], m = [];
                if (r(e, function (e) {
                        var t = e.name, n = e.size;
                        return !1 === /\.(jpg|jpeg|png|bmp|gif)$/i.test(t) ? void m.push("【" + t + "】不是图片") : o < n ? void m.push("【" + t + "】大于 " + c + "M") : void g.push(e)
                    }), m.length)return void this._alert("图片验证未通过: \n" + m.join("\n"));
                var w = new FormData;
                if (r(g, function (e) {
                        w.append(e.name, e)
                    }), a && "string" == typeof a) {
                    ...
                    var b = v[1] || "";
                    A(d, function (e, t) {
                        a.indexOf("?") > 0 ? a += "&" : a += "?", a += e + "=" + encodeURIComponent(t)
                    }), b && (a += b);
                    var E = new XMLHttpRequest;
                    return E.timeout = p, E.ontimeout = function () {
                        h.timeout && "function" == typeof h.timeout && h.timeout(E, n), t._alert("上传图片超时")
                    }, E.upload && (E.upload.onprogress = function (e) {
                        var t = void 0;
                        e.lengthComputable && (t = e.loaded / e.total, n.bar.show("上传进度: " + s(t)), 1 === t && setTimeout(function () {
                            n.bar.hide()
                        }, 1e3))
                    }), E.onreadystatechange = function () {
                        var e = void 0;
                        if (4 === E.readyState && 200 === E.status) {
                            if (200 !== E.status)return h.error && "function" == typeof h.error && h.error(E, n), void t._alert("上传图片发生错误", "上传图片发生错误，服务器返回状态是 " + E.status);
                            if (e = E.responseText, "object" !== (void 0 === e ? "undefined" : V(e)))try {
                                e = JSON.parse(e)
                            } catch (i) {
                                return h.fail && "function" == typeof h.fail && h.fail(E, n, e), void t._alert("上传图片失败", "上传图片返回结果错误，返回结果是: " + e)
                            }
                            if ("0" != e.errno) h.fail && "function" == typeof h.fail && h.fail(E, n, e), t._alert("上传图片失败", "上传图片返回结果错误，返回结果 errno=" + e.errno); else {
                                (e.data || []).forEach(function (e) {
                                    t.insertLinkImg(e)
                                }), h.success && "function" == typeof h.success && h.success(E, n, e)
                            }
                        }
                    }, h.before && "function" == typeof h.before && h.before(E, n, g), E.open("POST", a), A(u, function (e, t) {
                        E.setRequestHeader(e, t)
                    }), E.withCredentials = f, void E.send(w)
                }
                l && r(e, function (e) {
        ...
        constructor: Y, init: function () {
            var e = this.editor, t = e.$textContainerElem, n = o('<div class="w-e-bar"></div>');
            t.append(n), this.$bar = n
        }, showOnce: function (e) {
            var t = this;
            this.show(e), setTimeout(function () {
                t.hide()
            }, 1500)
        }, show: function (e) {
            var t = this.$bar;
    ...
    var O = 1;
    H.prototype = {
        constructor: H, _initDom: function () {
            var e = this.toolbarSelector, t = o(e), n = this.textSelector, i = void 0, A = void 0, r = void 0,
                c = void 0;
            null == n ? (i = o("<div></div>"), A = o("<div></div>"), c = t.children(), t.append(i).append(A), i.css("background-color", "#f6f6f6").css("border", "1px solid #dcdcdc"), A.css("border", "1px solid #dcdcdc").css("border-top", "none").css("height", "300px")) : (i = t, A = o(n), c = A.children()), r = o("<div></div>"), r.attr("contenteditable", "true").css("width", "100%").css("height", "100%"), c && c.length ? r.append(c) : r.append(o("<p><br></p>")), A.append(r), i.addClass("w-e-toolbar"), A.addClass("w-e-text-container"), r.addClass("w-e-text"), this.$toolbarElem = i, this.$textContainerElem = A, this.$textElem = r
            ...
            this.menus = new U(this), this.menus.init()
        }, _initText: function () {
            this.txt = new S(this), this.txt.init()
        }, _addBar: function () {
            this.bar = new Y(this), this.bar.init()
        }, create: function () {
            this._initDom(), this._initConfig(), this._initCommand(), this._initSelectionAPI(), this._initText(), this._initMenus(), this._initUploadImg(), this._addBar()
        }
    };
    try {
        document
